...
/** Fase III: the supplier follows the review and re-uploads pending or rejected documents. */
export function DocumentTracker({
  ...
  const cargarDoc = useMutation(api.onboarding.suppliersPublic.cargarDocumentoRevision);
  ...
  return (
    <PublicShell branding={branding} titulo="Inscripción de Proveedores" subtitulo="Su formulario fue firmado. El equipo de Cumplimiento y Compras está revisando los documentos.">
      <div className="mx-auto w-full max-w-2xl px-4 py-8">
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-slate-900">Revisión Documental</h1>
          <p className="mt-1 text-sm text-slate-500">{inscripcion.datos_generales_01.razonSocial} — El equipo de Cumplimiento está revisando sus documentos.</p>
          {total > 0 && (
