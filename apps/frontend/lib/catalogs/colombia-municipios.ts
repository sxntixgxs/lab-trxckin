 ...
 * Fuente: https://github.com/marcovega/colombia-json (lista DIVIPOLA de DANE).
 * Se usa en el formulario de inscripci\u00f3n de proveedores (secci\u00f3n Informaci\u00f3n tributaria)
 * para capturar municipios donde el tercero es responsable de ICA, sujeto de retenci\u00f3n
 * de ICA o autorretenedor de ICA.
 */

export interface DepartamentoCatalog {
  departamento: string;
  municipios: string[];
}

export const COLOMBIA_DEPARTAMENTOS_MUNICIPIOS: DepartamentoCatalog[] = [
  { departamento: "Amazonas", municipios: ["Leticia", "Puerto Nari\u00f1o"] },
  {
    ...
    municipios: [
      ...
      "Ca\u00f1asgordas", "Caracol\u00ed", "Caramanta", "Carepa", "Carolina del Pr\u00edncipe",
      "Caucasia", "Chigorod\u00f3", "Cisneros", "Ciudad Bol\u00edvar", "Cocorn\u00e1",
      "Concepci\u00f3n", "Concordia", "Copacabana", "Dabeiba", "Donmat\u00edas",
      ...
      "Marinilla", "Medell\u00edn", "Montebello", "Murind\u00f3", "Mutat\u00e1", "Nari\u00f1o",
      ...
      "San Luis", "San Pedro de Urab\u00e1", "San Pedro de los Milagros", "San Rafael",
  ...
  },
  {
    ...
    municipios: [
      ...
      "San Jacinto", "San Juan Nepomuceno", "San Mart\u00edn de Loba", "San Pablo",
  ...
  },
  {
    ...
    municipios: [
      ...
      "Pajarito", "Panqueba", "Pauna", "Paya", "Paz del R\u00edo", "Pesca", "Pisba",
      ...
      "Tinjac\u00e1", "Tipacoque", "Toca", "Tog\u00fc\u00ed", "T\u00f3paga", "Tota",
      "Tunja", "Tunungu\u00e1", "Turmequ\u00e9", "Tuta", "Tutaz\u00e1", "\u00dambita",
  ...
  },
  {
    ...
    municipios: [
      ...
      "Guap\u00ed", "Inz\u00e1", "Jambal\u00f3", "La Sierra", "La Vega",
      ...
      "Santander de Quilichao", "Silvia", "Sotar\u00e1", "Su\u00e1rez", "Sucre",
  ...
  },
  {
    ...
    municipios: [
      ...
      "Bojay\u00e1", "Cant\u00f3n de San Pablo", "C\u00e9rtegui", "Condoto", "El Atrato",
      "El Carmen de Atrato", "El Carmen del Dari\u00e9n", "Istmina", "Jurad\u00f3",
      "Litoral de San Juan", "Llor\u00f3", "Medio Atrato", "Medio Baud\u00f3",
      "Medio San Juan", "N\u00f3vita", "Nuqu\u00ed", "Quibd\u00f3", "R\u00edo Ir\u00f3",
      "R\u00edo Quito", "Riosucio", "San Jos\u00e9 del Palmar", "Sip\u00ed", "Tad\u00f3",
  ...
  },
  {
    ...
    municipios: [
      ...
      "Beltr\u00e1n", "Bituima", "Bogot\u00e1", "Bojac\u00e1", "Cabrera", "Cachipay",
      ...
      "Simijaca", "Soacha", "Sop\u00f3", "Subachoque", "Suesca", "Supat\u00e1", "Susa",
      "Sutatausa", "Tabio", "Tausa", "Tena", "Tenjo", "Tibacuy", "Tibirita",
      "Tocaima", "Tocancip\u00e1", "Topaip\u00ed", "Ubal\u00e1", "Ubaque", "Ubat\u00e9",
      "Une", "\u00datica", "Venecia", "Vergara", "Vian\u00ed", "Villag\u00f3mez",
      "Villapinz\u00f3n", "Villeta", "Viot\u00e1", "Yacop\u00ed", "Zipac\u00f3n",
      "Zipaquir\u00e1",
    ],
  },
  ...
  },
  {
    departamento: "Nari\u00f1o",
    municipios: [
      "Aldana", "Ancuy\u00e1", "Arboleda", "Barbacoas", "Bel\u00e9n", "Buesaco",
      "Chachag\u00fc\u00ed", "Col\u00f3n", "Consac\u00e1", "Contadero", "C\u00f3rdoba",
      ...
      "San Bernardo", "San Jos\u00e9 de Alb\u00e1n", "San Lorenzo", "San Pablo",
      "San Pedro de Cartago", "Sandon\u00e1", "Santa B\u00e1rbara", "Santacruz",
  ...
  },
  {
    ...
    municipios: [
      ...
      "Duran\u00eda", "El Carmen", "El Tarra", "El Zulia", "Gramalote", "Hacar\u00ed",
      "Herr\u00e1n", "La Esperanza", "La Playa de Bel\u00e9n", "Labateca", "Los Patios",
      "Lourdes", "Mutiscua", "Oca\u00f1a", "Pamplona", "Pamplonita", "Puerto Santander",
      "Ragonvalia", "Salazar de Las Palmas", "San Calixto", "San Cayetano", "Santiago",
  ...
  },
  {
    ...
    municipios: ["Providencia y Santa Catalina Islas", "San Andr\u00e9s"],
  },
  {
    ...
    municipios: [
      ...
      "Carcas\u00ed", "Cepit\u00e1", "Cerrito", "Charal\u00e1", "Charta", "Chima",
      "Chipat\u00e1", "Cimitarra", "Concepci\u00f3n", "Confines", "Contrataci\u00f3n",
      "Coromoro", "Curit\u00ed", "El Carmen de Chucur\u00ed", "El Guacamayo",
      "El Pe\u00f1\u00f3n", "El Play\u00f3n", "El Socorro", "Encino", "Enciso",
      "Flori\u00e1n", "Floridablanca", "Gal\u00e1n", "G\u00e1mbita", "Gir\u00f3n", "Guaca",
  ...
  },
  {
    ...
    municipios: [
      ...
      "Morroa", "Ovejas", "Sampu\u00e9s", "San Antonio de Palmito", "San Benito Abad",
  ...
  { departamento: "Vaup\u00e9s", municipios: ["Carur\u00fa", "Mit\u00fa", "Taraira"] },
  { departamento: "Vichada", municipios: ["Cumaribo", "La Primavera", "Puerto Carre\u00f1o", "Santa Rosal\u00eda"] },
];

/** Lista \u00fanica de municipios (para selector tipo `value=label`) con formato "Municipio (Departamento)" para desambiguar homonimias. */
export const COLOMBIA_MUNICIPIOS_OPTIONS: { label: string; value: string }[] =
  COLOMBIA_DEPARTAMENTOS_MUNICIPIOS.flatMap(({ departamento, municipios }) =>
    municipios.map((m) => ({
      label: `${m} (${departamento})`,
